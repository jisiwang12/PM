                            ...
                            <div class="">
                                <div class="form-group form-inline">
                                    <div class="btn-group">
                                        ...
                                        <button type="button" class="btn btn-default" title="刷新" onclick="location.href='${pageContext.request.contextPath}/course/findAll_admin'">
                            ...
                            <form action="${pageContext.request.contextPath}/course/del" id="form">
                                <table id="dataList"
                                    ...
                                    <c:forEach items="${courseList}" var="course">
                                        <c:if test="${course.status==2||course.status==3}">
                                            <tr>
                                                ...
                                                <c:if test="${course.status==2}">
                                                    <td style="width: 200px" class="text-center">
                                                        ...
                                                        <a href="${pageContext.request.contextPath}/course/go_admin/?id=${course.cono}" class="btn bg-olive btn-xs">提交审核</a>
                                                        <a href="${pageContext.request.contextPath}/course/back_admin/?id=${course.cono}" class="btn bg-olive btn-xs">退回</a>
                                                    </td>
                                                </c:if>
                                                <c:if test="${course.status==3}">
                                                    <td class="text-center">
