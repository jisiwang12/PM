    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a
                        href="${pageContext.request.contextPath}/student/findAll">课程管理</a></li>
                ...
                <section class="content"> <!--产品信息-->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="row data-type">
                            <input type="hidden" name="coid" value="${course.coid}">
                            ...
                            <div class="col-md-4 data">
                                <input type="text" class="form-control" name="xf"
                                       value="${course.xf}">
                            </div>
                            <div class="col-md-2 title">开课学期</div>
                            <div class="col-md-4 data">
                            ...
                            <div class="col-md-4 data">
                                <select class="form-control select2" style="width: 100%"
                                    ...
                                    <c:forEach items="${teacherList}" var="teacher">
                                        <c:if test="${course.tid==teacher.id}">
                            ...
                            <div class="col-md-4 data">
                                <select class="form-control select2" style="width: 100%"
                                    ...
                                    <c:if test="${course.status==0}">
                                        <option selected value="0">已开课</option>
                                        <option  value="1">未开课</option>
                                    </c:if>
                                    <c:if test="${course.status==1}">
                                        <option selected value="1">未开课</option>
        ...
        <security:authorize access="hasRole('ROLE_STUDENT')">
            <form action="${pageContext.request.contextPath}/student/update_stu"
                  method="post">
                <!-- 正文区域 -->
                <section class="content"> <!--产品信息-->
                            ...
                            <div class="col-md-4 data">
                                ...
                                >
                                    <c:forEach items="${classList}" var="c">
                                        <c:if test="${student.classn.cid==c.cid}">
