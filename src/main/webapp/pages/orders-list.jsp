							...
							<table id="dataList"
								...
								<thead>
									<tr>
										...
										<th class="sorting">迟到次数</th>
										<th class="text-center sorting">旷课次数</th>
									...
									<c:forEach items="${allList}" var="all">
										...
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/kq/findById?id=${all.kqid}"><button type="button" class="btn bg-olive btn-xs">修改</button></a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
