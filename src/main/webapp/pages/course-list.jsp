    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a
                        href="${pageContext.request.contextPath}/student/findAll">课程信息管理</a></li>
        ...
        <section class="content"> <!-- .box-body -->
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="table-box">
                        ...
                        <div class="">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="新建" onclick="location.href='${pageContext.request.contextPath}/course/page'">
                                    ...
                                    <button type="button" class="btn btn-default" title="刷新" onclick="location.href='${pageContext.request.contextPath}/course/findAll'">
                        ...
                        <form action="${pageContext.request.contextPath}/course/del" id="form">
                            <table id="dataList"
                                ...
                                <c:forEach items="${courseList}" var="course">
                                    <tr>
                                        <td><input name="ids" type="checkbox" value="${course.coid}"></td>
                                        ...
                                        <c:if test="${course.status==0||course.status==2||course.status==3||course.status==4}">
                                        <td class="text-center"><span class="badge bg-red">已开课</span></td>
                                        </c:if>
                                        <c:if test="${course.status==1}">
                                            <td class="text-center" style=""><span class="badge bg-yellow">
                                                    ${course.statusStr}</span></td>
                                        </c:if>
                                        ...
                                        <td class="text-center">
                                            <a href="${pageContext.request.contextPath}/course/findById/?id=${course.coid}" class="btn bg-olive btn-xs">修改</a>
                                            <a href="${pageContext.request.contextPath}/xk/findByCoid/?id=${course.coid}" class="btn bg-olive btn-xs">导入上课学生</a>
                                        </td>
                                        </c:if>
                                        <c:if test="${course.status==0||course.status==2||course.status==3||course.status==4||course.status==5}">
                                        <td class="text-center">
                    ...
                    <!-- 数据表格 /-->
                        <security:authorize access="hasAnyRole('ROLE_YXZR')">
                            ...
                            <div class="table-box">
                                ...
                                <form action="${pageContext.request.contextPath}/course/del" id="form">
                                    <table id="dataList"
                                        ...
                                        <tbody>
                                        <c:forEach items="${courseList}" var="course">
                                            <c:if test="${course.status==3||course.status==4}">
                                            <tr>
                                                <td class="text-center">${course.coname}</td>
                                                <td class="text-center">${course.xf }</td>
                                                <td class="text-center">${course.teacher.name}</td>
                                                ...
                                                <c:if test="${course.status==3}">
                                                    <td style="width: 200px" class="text-center">
                                                        <a href="${pageContext.request.contextPath}/score/findByCono/?id=${course.cono}" class="btn bg-olive btn-xs">查看成绩</a>
                                                        <a href="${pageContext.request.contextPath}/course/go/?id=${course.cono}" class="btn bg-olive btn-xs">提交审核</a>
                                                        <a href="${pageContext.request.contextPath}/course/back/?id=${course.cono}" class="btn bg-olive btn-xs">退回</a>
                                                    </td>
                                                </c:if>
                                                <c:if test="${course.status==4}">
                                                    <td class="text-center">
                        ...
                        <div class="table-box">
                            ...
                            <form action="${pageContext.request.contextPath}/course/del" id="form">
                                <table id="dataList"
                                    ...
                                    <tbody>
                                    <c:forEach items="${courseList}" var="course">
                                        <c:if test="${course.status==4||course.status==5}">
                                            <tr>
                                                <td class="text-center">${course.coname}</td>
                                                <td class="text-center">${course.xf }</td>
                                                <td class="text-center">${course.teacher.name}</td>
                                                ...
                                                <c:if test="${course.status==4}">
                                                    <td style="width: 200px" class="text-center">
                                                        <a href="${pageContext.request.contextPath}/score/findByCono/?id=${course.cono}" class="btn bg-olive btn-xs">查看成绩</a>
                                                        <a href="${pageContext.request.contextPath}/course/go_yz/?id=${course.cono}" class="btn bg-olive btn-xs">确认审核</a>
                                                        <a href="${pageContext.request.contextPath}/course/back/?id=${course.cono}" class="btn bg-olive btn-xs">退回</a>
                                                    </td>
                                                </c:if>
                                                <c:if test="${course.status==5}">
