...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                院长管理 <small>院长表单</small>
            </h1>
            <ol class="breadcrumb">
                <li><a href="${pageContext.request.contextPath}/index.jsp"><i
                        class="fa fa-dashboard"></i> 首页</a></li>
                <li><a
                        href="${pageContext.request.contextPath}/yz/findAll">院长信息管理</a></li>
                <li class="active">院长表单</li>
            </ol>
        </section>
        <!-- 内容头部 /-->
        <security:authorize access="hasRole('ROLE_ADMIN')">
        <form action="${pageContext.request.contextPath}/yz/update"
              method="post">
            </security:authorize>
                <security:authorize access="hasRole('ROLE_YZ')">
                <form action="${pageContext.request.contextPath}/yz/update_yz"
                      method="post">
                    </security:authorize>
            <!-- 正文区域 -->
