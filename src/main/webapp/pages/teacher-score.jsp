                                            ...
                                            <tr>
                                                ...
                                                <c:if test="${course.status==0}">
                                                    <td class="text-center">
                                                        <a href="${pageContext.request.contextPath}/course/go_teacher?id=${course.cono}"
                                                           class="btn bg-olive btn-xs">提交审核</a>
                                                        <a href="${pageContext.request.contextPath}/score/findByCono/?id=${course.cono}"
