                    ...
                    <div class="table-box">
                        ...
                        <div class="">
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <button type="button" class="btn btn-default" title="录入"
                                            data-toggle="modal"
                                            data-target="#myModal">
                                        <i class="fa fa-file-o"></i> 录入
                                    </button>
                        ...
                        <div style="" class="pull-right">
                            ...
                            <select class="form-control select2 " style="width: 220px" id="changeTime"
                                    onchange="changeTime()">
                                <option selected>可选课学生</option>
                                <option>已选课学生</option>
                            </select>
                        </div>
                        <form action="${pageContext.request.contextPath}/xk/save" id="form" method="post">
                            <table id="dataList"
                                ...
                                <tbody>
                                <input name="xcoid" type="text" style="display: none" value="${course.coid}">
                                <c:forEach items="${noXK}" var="student">
                                    <tr>
                                        <td><input name="snos" type="checkbox" value="${student.sNo}">
...
<script>
    ...
    function changeTime() {
        location.href = "${pageContext.request.contextPath}/xk/findXK?coid=${course.coid}";
    }
