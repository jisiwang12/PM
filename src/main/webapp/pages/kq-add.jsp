...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <form action="${pageContext.request.contextPath}/kq/save"
              method="get">
            <!-- 正文区域 -->
            <section class="content"> <!--产品信息-->

                <div class="panel panel-default">
                    <div class="panel-heading">考勤信息添加</div>
                    <div class="row data-type">
                        ...
                        <div class="col-md-4 data">
                            <select class="form-control select2" style="width: 100%"
                                ...
                                <c:forEach items="${studentList}" var="c">
                                        <option value="${c.sNo}" >${c.sNo}</option>
                                </c:forEach>
                            </select>
                        </div>
                        ...
                        <div class="col-md-4 data">
                            ...
                            <c:forEach items="${courseList}" var="c">
                                <option value="${c.cono}">${c.coname}</option>
                            </c:forEach>
                        </select>
                        </div>
                        ...
                        <div class="col-md-2 title">考勤分数</div>
                        <div class="col-md-4 data">
                            <input type="text" class="form-control" name="kqscore"
                                    value=0>
                        </div>
