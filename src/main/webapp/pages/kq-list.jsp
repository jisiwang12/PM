        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <security:authorize access="hasRole('ROLE_STUDENT')">
                    <li><a href="${pageContext.request.contextPath}/kq/findBySno?sno=t${kqList.get(0).sno}">课程考勤成绩</a>
                    </li>
                </security:authorize>
                                ...
                                <div class="btn-group">
                                    <security:authorize access="hasRole('ROLE_STUDENT')">
                                        <button type="button" id="sx" class="btn btn-default" title="刷新"
                                                onclick="location.href='${pageContext.request.contextPath}/kq/findBySno?sno=t${kqList.get(0).sno}'">
                                            <i class="fa fa-refresh"></i> 刷新
                                        </button>
                                    </security:authorize>
                                    <security:authorize access="hasRole('ROLE_TEACHER')">
                                        <button type="button" id="sx" class="btn btn-default" title="刷新"
                                                onclick="location.href='${pageContext.request.contextPath}/kq/findByCono?id=${kqList.get(0).cono}'">
                                            <i class="fa fa-refresh"></i> 刷新
                                        </button>
                                    </security:authorize>
                                </div>
                                ...
                                <tr>
                                    ...
                                    <security:authorize access="hasRole('ROLE_TEACHER')">
                                        <td class="text-center">
                                            <a href="${pageContext.request.contextPath}/kq/findById/?id=${all.kqid}"
