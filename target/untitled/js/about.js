...
layui.use(['element', 'jquery', 'form', 'layedit'], function () {
    ...
    form.on('submit(formReply)', function (data) {
        ...
        setTimeout(function () {
            ...
            var html = '<div class="comment-child"><img src="../images/F.png"alt="F"/><div class="info"><span class="username">模拟回复</span><span>' + content + '</span></div><p class="info"><span class="time">2019-09-18 18:26</span></p></div>';
